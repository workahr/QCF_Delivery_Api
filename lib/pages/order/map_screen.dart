...
class _SimpleMapScreenState extends State<SimpleMapScreen> {
  ...
  Future<void> _navigateToDestination() async {
    ...
    final String googleMapsUrl =
        "https://www.google.com/maps/dir/?api=1&origin=$latitude,$longitude&destination=${widget.lat},${widget.long}&travelmode=driving";

    final String appleMapsUrl =
        "https://maps.apple.com/?saddr=$latitude,$longitude&daddr=${widget.lat},${widget.long}";

...
import '../pages/json_data/floatingbalanceorderdetails_json.dart';
...
import '../pages/json_data/orderdish_json.dart';
import '../pages/json_data/totalearnings_json.dart';
import '../pages/json_data/totalfloating_model.dart';
import '../pages/json_data/trip_list_json.dart';
...
// update Entry ClientVisit
  ...
  Future gettotalearning() async {
    try {
      ...
      var result = await gettotalearningPageJsonData();
      return jsonEncode(result);
    } catch (e) {
      // Handle any errors
  ...
  Future gettotalfloating() async {
    try {
      ...
      var result = await gettotalfloatingPageJsonData();
      return jsonEncode(result);
    } catch (e) {
      // Handle any errors
      throw Exception('Failed to retrieve TotalEarning: $e');
  ...
  Future getfloatingorder() async {
    try {
      ...
      var result = await getfloatingoderdetailsPageJsonData();
      return jsonEncode(result);
    } catch (e) {
      // Handle any errors
      throw Exception('Failed to retrieve TotalEarning: $e');
  ...
  Future getOrderList() async {
    try {
      // Create a list of OrderList with hardcoded data

      var result = await getOrderListJsonData();
      return jsonEncode(result);
    } catch (e) {
      // Handle any errors
      throw Exception('Failed to retrieve AddtoCart: $e');
  ...
  Future getTripList() async {
    try {
      // Create a list of TripList with hardcoded data

      var result = await getTripListJsonData();
      return jsonEncode(result);
    } catch (e) {
      // Handle any errors
      throw Exception('Failed to retrieve AddtoCart: $e');
  ...
  //order pickup dish list

  Future getpickupdishlist() async {
    try {
      // Create a list of DriversList with hardcoded data

      var result = await getOrderConfirmLocationListJsonData();
      return jsonEncode(result);
    } catch (e) {
      // Handle any errors
      throw Exception('Failed to retrieve TotalEarning: $e');
